...
class Yolo3DMapperNode(Node):
    def __init__(self):
        ...
        self.get_logger().info('★ 모든 데이터 수신 대기 중... "s" 키를 누르면 [검사 및 데이터 전송]이 시작됩니다. ★')
    ...
    def process_capture(self):
        ...
        self.get_logger().info('☁️ 1m 이내 포인트 클라우드 필터링 및 변환 작업 중...')
        ...
        # 브라우저 교차 권한 통과를 위해 전역 변수 할당문 주입
